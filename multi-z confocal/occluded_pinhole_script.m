...
d = set_up_domains(p); 
d.pinhole = make_pinhole(d.posIdx,p.pinholeDiam);
...
% Calculate occluded detection PSFs
detectPSF = compute_multiple_occluded_PSFs(d.pinhole,p.pinholeLocations,d.emZPosIdx,d.sfIdx,p.k_em,p.sfCutoff_em);
...
saveastiff(projImage,'test2.tif')
